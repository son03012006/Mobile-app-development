...
import com.example.inventoryapproom.ui.item.formatedPrice
...
fun HomeScreen(
    ...
    // SỬA TẠI ĐÂY: Kết nối với ViewModel
    viewModel: HomeViewModel = viewModel(factory = AppViewModelProvider.Factory)
) {
    // SỬA TẠI ĐÂY: Thu thập dữ liệu từ Database (Flow -> State)
    ...
    Scaffold(
        ...
        HomeBody(
            // SỬA TẠI ĐÂY: Truyền danh sách itemList thật vào
